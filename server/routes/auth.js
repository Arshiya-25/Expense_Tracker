...
// These are the only routes that DON'T need a JWT (you don't have one yet!)
...
// The token expires in 7 days — after that, user must log in again
...
router.patch("/profile", async (req, res) => {
  try {
    ...
    if (req.body.monthlyIncome !== undefined) updates.monthlyIncome = req.body.monthlyIncome;
    if (req.body.savingsGoal !== undefined) updates.savingsGoal = req.body.savingsGoal;
    if (req.body.monthlyIncomeGoal !== undefined) updates.monthlyIncomeGoal = req.body.monthlyIncomeGoal;
