...
// Create the context (an empty container)
const AuthContext = createContext();

// Create the Provider — wraps whole app, makes data available everywhere
export function AuthProvider({ children }) {
  ...
  // Provide the values — any child component can access these
  return (
...
// Instead of const { user } = useContext(AuthContext) we used const { user } = useAuth()
