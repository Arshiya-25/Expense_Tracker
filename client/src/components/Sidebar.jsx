  ...
  return (
    <aside style={{
      ...
      <div style={{ padding: "0 8px 28px", display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <span style={{ fontWeight: 600, fontSize: 16, letterSpacing: "-0.02em" }}>FinFlow</span>
      </div>

      {/* Navigation */}
      <nav style={{ flex: 1, display: "flex", flexDirection: "column", gap: 4 }}>
        <p style={{ fontSize: 11, color: "var(--text3)", fontWeight: 500, letterSpacing: "0.06em", textTransform: "uppercase", padding: "0 8px", marginBottom: 8 }}>
          MENU
        </p>
        {NAV_ITEMS.map((item) => (
          <NavLink
          ...
          >
            {({ isActive }) => (
              <>
                <span style={{ color: isActive ? "var(--accent)" : "currentColor" }}>
                  {item.icon}
                </span>
                {item.label}
                {/* Active dot */}
